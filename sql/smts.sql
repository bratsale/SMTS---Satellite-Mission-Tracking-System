...
-- Schema smts_baza
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `smts_baza` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
USE `smts_baza` ;
...
CREATE TABLE IF NOT EXISTS `smts_baza`.`Komunikacija` (
  ...
  `stanica_id` INT(11) NULL DEFAULT NULL,
  `datum_komunikacije` DATE NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `smts_baza`.`Sudjelovanje` (
  `sudjelovanje_id` INT(11) NOT NULL AUTO_INCREMENT,
  `misija_id` INT(11) NULL DEFAULT NULL,
  `operater_id` INT(11) NULL DEFAULT NULL,
  `uloga_id` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`sudjelovanje_id`),
  INDEX `misija_id` (`misija_id` ASC) VISIBLE,
